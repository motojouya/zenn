...
そもそもこれを思いついたのは、kvsから取り出した階層構造のデータに、内容如何でロジックを付け足すというrepositoryを作ったことで思いついた。なので由来はそっち。repoの中で変換ロジックが肥大化したので、dtoとともに切り離し、それがさらにrepoを剥がして今の形になった。
